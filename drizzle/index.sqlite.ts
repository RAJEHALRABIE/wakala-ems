...
// Schema with relations for Drizzle
export const schema = {
  users,
  agents: agents.extend(agentsRelations),
  clients: clients.extend(clientsRelations),
  settings,
  documents: documents.extend(documentsRelations),
};
