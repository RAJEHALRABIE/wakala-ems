...
interface FinancialInput {
  areaSqm?: number | null;
  expectedCompensationPerSqm?: number | null;
  possessionRatio?: number | null;
  baseFeePercentage?: number | null;
  damageToRemainingComp?: number | null;
  extraCompRate?: number | null;
  officialCompensationAmount?: number | null;
