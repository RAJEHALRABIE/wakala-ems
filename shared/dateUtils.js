 ...
 */
export function formatHijriDate(hijriDate, format = 'short') {
 ...
 */
export function formatGregorianDate(date, format = 'short') {
 ...
 * @returns Date object in Gregorian format
 */
export function parseHijriString(hijriString) {
